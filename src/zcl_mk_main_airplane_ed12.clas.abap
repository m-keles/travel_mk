CLASS zcl_mk_main_airplane_ed12 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_MK_MAIN_AIRPLANE_ED12 IMPLEMENTATION.
...
*    l_carrier->add_airplane( l_passenger_plane ).
    ...
    DATA(l_hotel1) = NEW zcl_mk_hotel( im_name = 'Hotel1' im_max_beds = 100 ).
    DATA(l_hotel2) = NEW zcl_mk_hotel( im_name = 'Hotel2' im_max_beds = 2222 ).
